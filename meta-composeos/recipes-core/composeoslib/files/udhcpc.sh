...
# modified for composeOs by LDV


[ -z "$1" ] && echo "Error: should be called from udhcpc" && exit 1

# composeOs
[ -f "/etc/composeos/net-dns.txt" ] && dns=$(cat /etc/composeos/net-dns.txt)
[ -f "/etc/composeos/net-domain.txt" ] && domain=$(cat /etc/composeos/net-domain.txt)
# composeOs
